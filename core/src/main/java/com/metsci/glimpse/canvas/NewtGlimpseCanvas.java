...
public class NewtGlimpseCanvas extends JPanel implements GlimpseCanvas
{
    private static final Logger logger = Logger.getLogger( NewtGlimpseCanvas.class.getName( ) );
    ...
    public NewtGlimpseCanvas( String profile, GLContext context )
    {
    ...
    public NewtGlimpseCanvas( GLContext context )
    {
        this( GLProfile.GL2GL3, context );
    }

    public NewtGlimpseCanvas( )
    {
    ...
    public void addDisposeListener( final JFrame frame, final GLAutoDrawable sharedContextSource )
    {
        ...
        frame.addWindowListener( new WindowAdapter( )
        {
            ...
            public void windowClosing( WindowEvent e )
            {
                ...
                frame.remove( NewtGlimpseCanvas.this );
            }
        } );
    }
    ...
    {
        return NewtGlimpseCanvas.class.getSimpleName( );
    }
