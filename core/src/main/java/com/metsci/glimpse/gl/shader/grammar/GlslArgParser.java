...
public class GlslArgParser extends Parser {
	public static final String[] tokenNames = new String[] {
		...
		"IVEC3", "IVEC4", "LCURLY", "LOW_PRECISION", "LPAREN", "MAT2", "MAT3", 
		"MAT4", "MEDIUM_PRECISION", "MULTILINE_COMMENT", "OUT", "PRECISION", "RCURLY", 
		"RETURN", "RPAREN", "SAMPLER1D", "SAMPLER1DARRAY", "SAMPLER2D", "SAMPLER2DARRAY", 
		"SAMPLERCUBE", "SEMI", "STRUCT", "TRUE", "UNIFORM", "USAMPLER1D", "USAMPLER2D", 
		"VARYING", "VEC2", "VEC3", "VEC4", "VOID", "WHILE", "WHITESPACE", "'main'"
	};
